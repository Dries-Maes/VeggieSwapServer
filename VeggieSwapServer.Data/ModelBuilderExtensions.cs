        ...
        private static void SeedUsers(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>(x =>
            {
                ...
                x.HasData(
                    ...
                    new User { Id = 4, FirstName = "Dries", LastName = "Maileniseenkunst", IsAdmin = true, Email = "Drieswilgraageenlangemail@mail.be", PasswordSalt = hmac.Key, PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes("1234")), ImageUrl = "Dries" },
