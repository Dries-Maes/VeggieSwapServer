...
namespace VeggieSwapServer.Data
{
    public static class ModelBuilderExtensions
    {
        ...
        private static void SeedTradeItems(ModelBuilder modelBuilder)
        {
            ...
            {
                x.HasData(
                new TradeItem { Id = 1, UserId = 10, ResourceId = 51, TradeId = 1, Amount = 2 },
                new TradeItem { Id = 2, UserId = 8, ResourceId = 11, TradeId = 2, Amount = 10 },
                new TradeItem { Id = 3, UserId = 13, ResourceId = 32, TradeId = 3, Amount = 50 },
                new TradeItem { Id = 4, UserId = 4, ResourceId = 24, TradeId = 4, Amount = 69 },
                new TradeItem { Id = 5, UserId = 5, ResourceId = 45, TradeId = 5, Amount = 45 },
                new TradeItem { Id = 6, UserId = 6, ResourceId = 6, TradeId = 6, Amount = 30 },
                new TradeItem { Id = 7, UserId = 7, ResourceId = 17, TradeId = 7, Amount = 42 },
                new TradeItem { Id = 8, UserId = 8, ResourceId = 8, TradeId = 8, Amount = 75 },
                new TradeItem { Id = 9, UserId = 9, ResourceId = 9, TradeId = 9, Amount = 201 },
                new TradeItem { Id = 10, UserId = 9, ResourceId = 10, TradeId = 10, Amount = 634 },
                new TradeItem { Id = 11, UserId = 11, ResourceId = 17, TradeId = 11, Amount = 20 },
                new TradeItem { Id = 12, UserId = 13, ResourceId = 26, TradeId = 12, Amount = 75 },
                new TradeItem { Id = 13, UserId = 10, ResourceId = 19, TradeId = 1, Amount = 69 },
                new TradeItem { Id = 14, UserId = 3, ResourceId = 49, TradeId = 4, Amount = 25 },
                new TradeItem { Id = 15, UserId = 4, ResourceId = 50, TradeId = 1, Amount = 35 },
                new TradeItem { Id = 16, UserId = 5, ResourceId = 7, TradeId = 8, Amount = 75 },
                new TradeItem { Id = 17, UserId = 3, ResourceId = 1, TradeId = 1, Amount = 10 },
                new TradeItem { Id = 18, UserId = 1, ResourceId = 6, TradeId = 9, Amount = 9 },
                new TradeItem { Id = 19, UserId = 12, ResourceId = 7, TradeId = 5, Amount = 17 },
                new TradeItem { Id = 20, UserId = 7, ResourceId = 36, TradeId = 1, Amount = 30 },
                new TradeItem { Id = 21, UserId = 6, ResourceId = 23, TradeId = 7, Amount = 78 },
                new TradeItem { Id = 22, UserId = 9, ResourceId = 27, TradeId = 9, Amount = 69 },
                new TradeItem { Id = 23, UserId = 1, ResourceId = 37, TradeId = 13, Amount = 180 },
                new TradeItem { Id = 24, UserId = 2, ResourceId = 47, TradeId = 7, Amount = 47 },
                new TradeItem { Id = 25, UserId = 6, ResourceId = 48, TradeId = 18, Amount = 20 },
                new TradeItem { Id = 26, UserId = 7, ResourceId = 39, TradeId = 13, Amount = 10 }
                );
            }
            );
        }
